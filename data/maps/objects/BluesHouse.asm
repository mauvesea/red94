...
BluesHouse_Object:
	...
	def_object_events
	object_event  2,  3, SPRITE_COOLTRAINER_F, STAY, RIGHT, TEXT_BLUESHOUSE_DAISY_SITTING
	object_event  6,  4, SPRITE_COOLTRAINER_F, WALK, UP_DOWN, TEXT_BLUESHOUSE_DAISY_WALKING, 0
