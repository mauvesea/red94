...
; SpriteSheetPointerTable indexes (see data/sprites/sprites.asm)
	...
	const SPRITE_HERMIT                  ; $32
	const SPRITE_MOM                     ; $33
	const SPRITE_BALDING_GUY             ; $34
	const SPRITE_LITTLE_BOY              ; $35
	const SPRITE_GAMEBOY_GIRL            ; $36
	const SPRITE_GAMEBOY_KID             ; $37
	const SPRITE_VIRTUALBOY_KID          ; $38
	const SPRITE_FAIRY                   ; $39
	const SPRITE_AGATHA                  ; $3a
	const SPRITE_BRUNO                   ; $3b
	const SPRITE_LORELEI                 ; $3c
	const SPRITE_SEEL                    ; $3d
